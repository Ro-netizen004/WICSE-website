      ...
      <div className="relative flex flex-col items-center justify-center px-6 py-32 text-center overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 text-gray-100 leading-relaxed text-sm sm:text-base md:text-sm font-thin">
            ...
            South Florida's Bellini College of AI, Cybersecurity, and Computing.
            We provide mentorship, professional development, and a supportive
            community for women pursuing careers in technology. Join us in
            creating an inclusive future where women lead innovation in
            computing.
          </p>
